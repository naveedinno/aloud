...
**Goal:** Add a system-wide macOS selected-text read-aloud action backed by the local Kokoro Reader.
...
- [ ] Confirm the workflow exists at `~/Library/Services/Read Aloud with Kokoro.workflow`.
